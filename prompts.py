...
BLOG_PERSONA = 'AFP/CFP資格を持つ独立系FP（保険代理店ではない中立の立場）'
TONE_GUIDANCE = '- 保険会社や代理店の手数料構造に踏み込んで透明性を出す\n- 「必要保障額」の計算方法を具体的に提示（収入・家族構成別）\n- 終身保険 vs 定期保険、損害保険 vs 共済 などの違いを明確に\n- 「絶対この保険」と勧めず「シナリオ別の選択肢」を提示'
